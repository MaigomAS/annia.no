    ...
    <GlassPanel className="group overflow-hidden transition hover:-translate-y-1 hover:border-cyanMist/35">
      ...
      <div className="p-6">
        <div className="mb-4 flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em]">
          <span className="rounded-full border border-cyanMist/30 bg-cyanMist/10 px-3 py-1 text-cyanMist">{challenge.category}</span>
          <span className="rounded-full border border-white/10 px-3 py-1 text-steel">{challenge.status}</span>
        </div>
