  ...
  return (
    <footer className="border-t border-white/10 px-5 py-12 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.2fr_.8fr_.8fr]">
        ...
        <div><p className="font-semibold text-bone">Platform</p><div className="mt-4 grid gap-2 text-steel"><Link to="/spring-challenges">Spring Challenges</Link><Link to="/ecosystem">Ecosystem Explorer</Link><Link to="/insights">Insights</Link></div></div>
